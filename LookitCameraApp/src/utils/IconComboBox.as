	...
	public class IconComboBox extends ComboBox
	{
		...
		**/
		...
		private function showIcon():void
		{
			...
			DisplayObject(displayIconObject).x = getStyle("cornerRadius") + 5;
			...
			textInput.x=DisplayObject(displayIconObject).width+getStyle("cornerRadius") + 5;;
			textInput.setStyle("fontSize", 12);
			textInput.setStyle("overflow", "none");
			textInput.setStyle("font-family","verdana");
