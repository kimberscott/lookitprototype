...
function check_conditions($experiment_id,$string) {  
  	...
  	if (strcmp($experiment_id, "testimony") == 0) { // Manual CB for 3-year-olds in Testimony
		...
		// Needed: 0,0,1,2,3,6,6,8,9,10,12,13,13,14,15,16,17,19,21,22,22,23,24,25,26,26,27,27,28,29,30,
		// Removed some we might have on 5/7/15
	  	$needed = array(0,0,1,3,6,8,10,12,13,14,15,21,23,24,25,26,26);
    	$c = $needed[rand(0, count($needed)-1)];
